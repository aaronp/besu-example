...
kubectl apply -f statefulsets/validator1-pvc.yaml
kubectl apply -f statefulsets/validator1-statefulset.yaml
kubectl apply -f statefulsets/validator2-pvc.yaml
kubectl apply -f statefulsets/validator2-statefulset.yaml
kubectl apply -f statefulsets/validator3-pvc.yaml
kubectl apply -f statefulsets/validator3-statefulset.yaml
kubectl apply -f statefulsets/validator4-pvc.yaml
